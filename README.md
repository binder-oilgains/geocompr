...
* `binder-oilgains`: [![Launch Rstudio
Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/binder-oilgains/geocompr/master?urlpath=rstudio)

* `binder-oilgains`: [![Launch Rstudio
Cloud](images/cloud.png)](https://rstudio.cloud/project/1642300)
[![Actions](https://github.com/binder-oilgains/geocompr/workflows/Render-Book-from-master/badge.svg)](https://github.com/Robinlovelace/geocompr/actions)
